...
const Products = () => {
  ...
  <div className="product">
    ...
    <div className="products">
      ...
      <div className="one">
        <img src="src\assets\product1.jpg" alt="product-1" className='img-product'/>
      ...
      <a href="https://wa.me/p/7997032913737634/917092572394" target='_blank'>
      <div className="two">
        <img src="src\assets\product2.jpg" alt="product-2" className='img-product'/>
      ...
      <div className="three">
        <img src="src\assets\product3.jpg" alt="product-3" className='img-product'/>
      ...
      <div className="four">
        <img src="src\assets\product4.jpg" alt="product-4" className='img-product'/>
      ...
      <div className="five">
        <img src="src\assets\product5.jpg" alt="product-5" className='img-product'/>
      ...
      <div className="six">
        <img src="src\assets\product6.jpg" alt="product-6" className='img-product'/>
